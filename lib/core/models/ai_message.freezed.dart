...
mixin _$AiMessage {
 ...
 String get content; bool get isError;/// Function Calling: assistant 消息中携带的工具调用列表
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AiMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.role, role) || other.role == role)&&(identical(other.content, content) || other.content == content)&&(identical(other.isError, isError) || other.isError == isError)&&const DeepCollectionEquality().equals(other.toolCalls, toolCalls)&&(identical(other.toolCallId, toolCallId) || other.toolCallId == toolCallId)&&(identical(other.isToolResultBubble, isToolResultBubble) || other.isToolResultBubble == isToolResultBubble));
}


@override
int get hashCode => Object.hash(runtimeType,id,role,content,isError,const DeepCollectionEquality().hash(toolCalls),toolCallId,isToolResultBubble);

@override
String toString() {
  return 'AiMessage(id: $id, role: $role, content: $content, isError: $isError, toolCalls: $toolCalls, toolCallId: $toolCallId, isToolResultBubble: $isToolResultBubble)';
}
...
@useResult
$Res call({
 String id, String role, String content, bool isError, List<Map<String, dynamic>>? toolCalls, String? toolCallId, bool isToolResultBubble
});
...
/// Create a copy of AiMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? role = null,Object? content = null,Object? isError = null,Object? toolCalls = freezed,Object? toolCallId = freezed,Object? isToolResultBubble = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String role,  String content,  bool isError,  List<Map<String, dynamic>>? toolCalls,  String? toolCallId,  bool isToolResultBubble)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AiMessage() when $default != null:
return $default(_that.id,_that.role,_that.content,_that.isError,_that.toolCalls,_that.toolCallId,_that.isToolResultBubble);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String role,  String content,  bool isError,  List<Map<String, dynamic>>? toolCalls,  String? toolCallId,  bool isToolResultBubble)  $default,) {final _that = this;
switch (_that) {
case _AiMessage():
return $default(_that.id,_that.role,_that.content,_that.isError,_that.toolCalls,_that.toolCallId,_that.isToolResultBubble);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String role,  String content,  bool isError,  List<Map<String, dynamic>>? toolCalls,  String? toolCallId,  bool isToolResultBubble)?  $default,) {final _that = this;
switch (_that) {
case _AiMessage() when $default != null:
return $default(_that.id,_that.role,_that.content,_that.isError,_that.toolCalls,_that.toolCallId,_that.isToolResultBubble);case _:
  return null;
...
class _AiMessage extends AiMessage {
  const _AiMessage({required this.id, required this.role, required this.content, this.isError = false, final  List<Map<String, dynamic>>? toolCalls = null, this.toolCallId = null, this.isToolResultBubble = false}): _toolCalls = toolCalls,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AiMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.role, role) || other.role == role)&&(identical(other.content, content) || other.content == content)&&(identical(other.isError, isError) || other.isError == isError)&&const DeepCollectionEquality().equals(other._toolCalls, _toolCalls)&&(identical(other.toolCallId, toolCallId) || other.toolCallId == toolCallId)&&(identical(other.isToolResultBubble, isToolResultBubble) || other.isToolResultBubble == isToolResultBubble));
}


@override
int get hashCode => Object.hash(runtimeType,id,role,content,isError,const DeepCollectionEquality().hash(_toolCalls),toolCallId,isToolResultBubble);
...
/// Create a copy of AiMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? role = null,Object? content = null,Object? isError = null,Object? toolCalls = freezed,Object? toolCallId = freezed,Object? isToolResultBubble = null,}) {
