...
mixin _$AppInfo {
 ...
 String get name; String get packageName; String get versionName; int get versionCode; bool get isSystemApp; Uint8List get icon;
...
@override
String toString() {
  return 'AppInfo(name: $name, packageName: $packageName, versionName: $versionName, versionCode: $versionCode, isSystemApp: $isSystemApp, icon: $icon)';
}
...
@useResult
$Res call({
 String name, String packageName, String versionName, int versionCode, bool isSystemApp, Uint8List icon
});
...
/// Create a copy of AppInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? packageName = null,Object? versionName = null,Object? versionCode = null,Object? isSystemApp = null,Object? icon = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String packageName,  String versionName,  int versionCode,  bool isSystemApp,  Uint8List icon)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String packageName,  String versionName,  int versionCode,  bool isSystemApp,  Uint8List icon)  $default,) {final _that = this;
switch (_that) {
case _AppInfo():
return $default(_that.name,_that.packageName,_that.versionName,_that.versionCode,_that.isSystemApp,_that.icon);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String packageName,  String versionName,  int versionCode,  bool isSystemApp,  Uint8List icon)?  $default,) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.name,_that.packageName,_that.versionName,_that.versionCode,_that.isSystemApp,_that.icon);case _:
  return null;
...
class _AppInfo extends AppInfo {
  const _AppInfo({required this.name, required this.packageName, required this.versionName, required this.versionCode, required this.isSystemApp, required this.icon}): super._();
...
/// Create a copy of AppInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? packageName = null,Object? versionName = null,Object? versionCode = null,Object? isSystemApp = null,Object? icon = null,}) {
